...
AUTH_USER = os.environ.get('AUTH_USERS', '6126688051,6039166844').split(',')
AUTH_USERS = [int(user_id) for user_id in AUTH_USER]
CHANNEL_OWNERS = {-1002335220633}
CHANNELS = os.environ.get('CHANNELS', '-1002335220633').split(',')
...
photoyt = 'https://i.ibb.co/hxQ73ZYw/photo-2025-04-12-18-46-28-7492500010408345604.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://i.ibb.co/jvQfvnCs/photo-2025-04-12-18-46-58-7492500195091939332.jpg'
photozip = 'https://i.ibb.co/Swd0WDW9/photo-2025-05-09-20-09-39-7502540716233457668.jpg'
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"ꞏ┅᪵┅᪵┅᪵⸻ꞏ┅᪵┅᪵┅᪵⸻THE BOYS ┅᪵┅᪵┅᪵ꞏ⸻┅᪵┅᪵┅᪵ꞏ\n"
        f"👤 𝐔𝐬𝐞𝐫 𝐀𝐮𝐭𝐡𝐞𝐧𝐭𝐢𝐜𝐚𝐭𝐢𝐨𝐧: **(OWNER)**\n\n" 
        f"➥ /addauth only 1 – Add User ID\n" 
        f"➥ /remauth many remives – Remove User ID\n"  
        f"➥ /users – Total User List\n"  
        f"ꞏ⸻┅᪵┅᪵┅᪵┅᪵┅᪵┅᪵ꞏस्ट्रेंजर┅᪵┅᪵┅᪵⸻ꞏꞏ┅᪵┅᪵┅᪵⸻\n"
        f"📁 𝐂𝐡𝐚𝐧𝐧𝐞𝐥𝐬: **(Auth Users)**\n\n" 
        f"➥ /addchnl -100 + chhanel – Add\n" 
        f"➥ /remchnl -100 + chhanel – Remove\n"  
        f"➥ /channels – List - (OWNER)\n"  
        f"ꞏ┅᪵┅᪵┅᪵⸻ꞏ┅᪵┅᪵┅᪵⸻समय यात्री⸻┅᪵┅᪵┅᪵ꞏ┅᪵┅᪵┅᪵ꞏ\n"
        f"💡 𝗡𝗼𝘁𝗲:\n\n"  
...
async def txt_handler(bot: Client, m: Message):  
    ...
    await editable.edit("**╭━━━━❰ᴇɴᴛᴇʀ ʀᴇꜱᴏʟᴜᴛɪᴏɴ❱━━➣ \n┣━━⪼ send `144`  for 144p\n┣━━⪼ send `240`  for 240p\n┣━━⪼ send `360`  for 360p\n┣━━⪼ send `480`  for 480p\n┣━━⪼ send `720`  for 720p\n┣━━⪼ send `1080` for 1080p\n╰━━⌈⚡[🦋STRANGER 🦋](https://i.ibb.co/Swd0WDW9/photo-2025-05-09-20-09-39-7502540716233457668.jpg)⚡⌋━━➣**")
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:
                cc = f'❖────[『 WELCOME STRANGER 』](https://i.ibb.co/ZRvCxd5g/STRANGER-BOY.jpg)──────❖**\n**[🤷‍♂️─🙋─👨‍🎓──🤦‍♂️─🧚‍♀️ {str(count).zfill(3)}  🧚‍♀️─🖤─💝─💔─🤷‍♂️]({link0})\n\n**★ 𝐍ᴀᴍᴇ ➤** `{name1}`\n**├── ★ Bot Made By ➤ **  🦋⃪꯭ ─‌⃛┼ 𝞄⃕𝖋𝖋 समय यात्री .mkv\n**├── ★ Resolution ➤** [{res}]\n\n**★ Course ➤** {b_name}\n\n**★ Extention ➤** [{CR}](https://i.ibb.co/DgRpQhw6/photo-2025-04-30-11-42-22-7499070258104238100.jpg)\n\n❖──── [『 HAPPY ENDING समय यात्री 』](https://envs.sh/49s.mp4) ────❖\n'
                cc1 = f'❖────[『 WELCOME STRANGER 』](https://i.ibb.co/ZRvCxd5g/STRANGER-BOY.jpg)──────❖**\n**[🤷‍♂️─🙋─👨‍🎓──🤦‍♂️─🧚‍♀️ {str(count).zfill(3)}  🧚‍♀️─🖤─💝─💔─🤷‍♂️]({link0})\n\n**📁 Title :** `{name1}`\n**├── ★ Bot Made By ➤**  🦋⃪꯭ ─‌⃛┼ 𝞄⃕𝖋𝖋 समय यात्री .pdf\n\n**★ Course ➤** {b_name}\n\n**★ Extention ➤** [{CR}](https://i.ibb.co/DgRpQhw6/photo-2025-04-30-11-42-22-7499070258104238100.jpg)\n\n❖──── [『 HAPPY ENDING समय यात्री 』](https://envs.sh/49s.mp4) ────❖\n'
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━🙆‍♂️ 𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 🤷‍♂️ [『 WELCOME STRANGER 』🙋](https://i.ibb.co/DgRpQhw6/photo-2025-04-30-11-42-22-7499070258104238100.jpg)"
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" \
                           f"🛑**Send** /stop **to stop process**\n┃\n" \
                           f"╰━🙆‍♂️ 𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 🤷‍♂️ [『 WELCOME STRANGER 』🙋](https://i.ibb.co/jvQfvnCs/photo-2025-04-12-18-46-58-7492500195091939332.jpg)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
...
async def text_handler(bot: Client, m: Message):
    ...
    await editable.edit("╭━━━━❰ᴇɴᴛᴇʀ ʀᴇꜱᴏʟᴜᴛɪᴏɴ❱━━➣ \n┣━━⪼ send `144`  for 144p\n┣━━⪼ send `240`  for 240p\n┣━━⪼ send `360`  for 360p\n┣━━⪼ send `480`  for 480p\n┣━━⪼ send `720`  for 720p\n┣━━⪼ send `1080` for 1080p\n╰━━⌈⚡[समय यात्री](https://i.ibb.co/jvQfvnCs/photo-2025-04-12-18-46-58-7492500195091939332.jpg)⚡⌋━━➣ ")
    ...
    try:
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"**⚡『 WELCOME STRANGER 』🙋 ...⏳**\n" \
                           f"🔗𝐋𝐢𝐧𝐤 » {url}\n" \
                           f"🙆‍♂️ 𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 🤷‍♂️ [『 WELCOME STRANGER 』](https://i.ibb.co/1YjMPGgZ/photo-2025-04-12-18-52-23-7492501513646899244.jpg)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.download_video(url, cmd, name)
                    filename = res_file
                    await prog.delete(True)
